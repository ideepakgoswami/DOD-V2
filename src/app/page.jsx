...
const Testimonials = dynamic(() => import("../components/DynamicHomeSections").then(mod => mod.Testimonials), { ssr: false });
const StudioGallery = dynamic(() => import("../components/DynamicHomeSections").then(mod => mod.StudioGallery), { ssr: false });
const InstagramSection = dynamic(() => import("../components/DynamicHomeSections").then(mod => mod.InstagramSection), { ssr: false });
...
image:"https://plus.unsplash.com/premium_photo-1720798650953-1bb37db7241c?q=80&w=898&auto=format&fit=crop&w=600&q=80",    },
 ...
 {/* Upcoming Events & Updates Section */}
      ...
      <StudioGallery studioGallery={studioGallery} />
      <InstagramSection />
